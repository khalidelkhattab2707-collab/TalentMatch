...
Provide a global dashboard with aggregate statistics across all offers and candidates, a ranked list of all candidates, and visual indicators for matching scores and recommendations.
