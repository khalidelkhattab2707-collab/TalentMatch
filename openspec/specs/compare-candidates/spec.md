...
Provide a standalone side-by-side comparison page for two analysed candidates, allowing RH agents to quickly evaluate and compare scores, skills, strengths, and weaknesses without using the conversational agent.
