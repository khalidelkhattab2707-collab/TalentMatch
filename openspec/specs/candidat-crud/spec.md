...
Allow recruiting agents to add candidates (candidats) to job offers by pasting CV text, view candidate details with AI analysis results, and manage candidate status.
