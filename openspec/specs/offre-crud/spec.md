...
This document specifies the CRUD operations for managing job offers (offres d'emploi) in the TalentMatch application. It covers listing, creating, viewing, editing, deleting, and filtering offers by status.
